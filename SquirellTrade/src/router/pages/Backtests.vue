    ...
    <v-responsive>
      ...
      <v-col cols="12" sm="6">
        ...
        <v-row class="mt-2 ml-2">
          ...
          <v-btn v-bind:variant="selectedFormat === 'SVG' ? 'elevated' : 'outlined'" @click="selectedFormat = 'SVG'" color="yellow-darken-2" class="mr-2 pa-1" size="large" density="compact" rounded="xl" >SVG</v-btn>
